# Auxiliary function, used in fem_solver_find_package().
function(fem_solver_find_component Prefix DirVar IncSuffixes Header LibSuffixes Lib
         IncDoc LibDoc)
...
endfunction(fem_solver_find_component)

#   FEM SOLVER version of find_package that searches for header/library and if
...
#
function(fem_solver_find_package Name Prefix DirVar IncSuffixes Header LibSuffixes
         Lib IncDoc LibDoc)
  ...
  fem_solver_find_component("${Prefix}" "${DirVar}" "${IncSuffixes}" "${Header}"
  ...
  while(I LESS ARGC)
    ...
    elseif ("${ARGV${I}}" STREQUAL "ADD_COMPONENT")
      ...
      if (CompRequested)
        ...
        fem_solver_find_component("${FullPrefix}" "${DirVar}"
...
endfunction(fem_solver_find_package)
